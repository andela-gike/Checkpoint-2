...
import * as documentAction from '../../../actions/actionTypes';
import DocumentForm from './DocumentForm';
import DocumentMarkdown from './DocumentValue';
...
export default connect(mapStateToProps, mapDispatchToProps)(DocumentDisplayer);
